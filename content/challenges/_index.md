...
banner:
  image: images/events/Hack4Rail_2025_073.jpg
  processes:
    - "fill 1900x600"
---
...
- [1 - DIRECT – Dynamic Inspector Routing for Efficient Coverage in Trains]({{% relref "1-direct" %}})
- [2 - Holiday Aware, Data Driven Relief Train Planning]({{% relref "2-relief-planning" %}})
- [3 - Robust Auto‑Layout Algorithms for the Netzgrafik Editor]({{% relref "3-nge-auto-layout" %}})
...
#### Challenges in this track:
- [4 - PopUpSim Optimizer]({{% relref "4-popup-sim" %}})
- [5 - Common Database for Technical Locomotive Data]({{% relref "5-loco-db" %}})
- [6 - Avoid the Nightmare with the Night Train]({{% relref "6-nighttrain-nightmare" %}})
- [7 - Who Makes the Rules?]({{% relref "7-rules" %}})
- [8 - Build an Open Model of Cross‑Border Mobility]({{% relref "8-cross-border-mobility" %}})
...
#### Challenges in this track:
- [9 - OneUI: Störfall Now! Fast Info. Right Info.]({{% relref "9-one-ui" %}})
- [10 - Digitalization of Taxi Vouchers and Passenger Pooling in Disruption Cases]({{% relref "10-taxi-vouchers" %}})
- [11 - Automatic Contract Analysis]({{% relref "11-contract-analysis" %}})
...
#### Challenges in this track:
- [12 - One Screen. One Journey. Integrated Station Information incl. Rail Replacement]({{% relref "12-one-screen" %}})
- [13 - A Spatial AI Wayfinding Agent for Railway Stations]({{% relref "13-wayfinding" %}})
- [14 - Station Data Unlocked (Somehow)]({{% relref "14-station-data" %}})
...
#### Challenges in this track:
- [15 - Predictive Model for Energy Consumption Including Weather Effects]({{% relref "15-energy-consumption" %}})
...
#### Challenges in this track:
- [16 - Route Roulette – A Playful Allocation Quest]({{% relref "16-route-roulette" %}})
- [17 - Rolling Stock Software Configuration Management]({{% relref "17-rolling-stock-config" %}})
- [18 - Infrastructure Congestion]({{% relref "18-infra-congestion" %}})
